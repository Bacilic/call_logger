...
void main() {
  ...
  testWidgets('εμφανίζει Μικροβελτιώσεις ανάμεσα σε Προστέθηκε και Άλλαξε', (
    tester,
  ) async {
    await pumpDialog(
      tester,
    ...
    expect(improvementsY, lessThan(tester.getTopLeft(find.text('Άλλαξε')).dy));
  });

  testWidgets('κρύβει Μικροβελτιώσεις όταν η λίστα είναι κενή', (tester) async {
    await pumpDialog(
      tester,
      entries: [
        ChangelogEntry.fromJson({
