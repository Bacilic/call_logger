// Συμβόλαιο Δ17 (β' σκέλος): τα artifacts ακεραιότητας εξασφαλίζονται στα
// ΓΡΑΠΤΑ μονοπάτια — όχι στο φόρτωμα της αναζήτησης, που είναι πλέον read-only.
//
//   flutter test test/core/database/old_database/lamp_write_paths_ensure_artifacts_test.dart
...
void main() {
  ...
  setUp(() async {
    tempDir = await Directory.systemTemp.createTemp('lamp-write-artifacts-');
  ...
  Future<void> seedBare({bool duplicateOwners = false}) async {
