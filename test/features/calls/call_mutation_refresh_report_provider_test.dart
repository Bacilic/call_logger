// Έλεγχος: refreshAfterCallMutation ακυρώνει lansweeperReportCallsProvider
...
void main() {
  ...
  group('refreshAfterCallMutation — lansweeperReportCallsProvider', () {
    setUp(() async {
      await bindCallLoggerIsolatedTestDatabase();
    });

    test(
      'refreshAfterCallMutation ακυρώνει lansweeperReportCallsProvider όταν invalidateHistory=true',
      () async {
        ...
        expect(
          container.read(lansweeperReportCallsProvider).hasValue,
          isTrue,
          reason:
        ...
        expect(
          ...
          isTrue,
          reason:
              'lansweeperReportCallsProvider πρέπει να ακυρωθεί μαζί με historyCallsProvider/dashboardStatsProvider',
        );
