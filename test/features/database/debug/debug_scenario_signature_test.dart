...
void main() {
  ...
  test(
    'ο σπορέας υπογράφει τη δοκιμαστική βάση μέσα στα δεδομένα της',
    () async {
  ...
  test(
    'η υπογραφή ταξιδεύει με το περιεχόμενο — η μετονομασία δεν την κρύβει',
    () async {
      await DatabaseHelper.instance.initializeDatabase();
      final seeder = IntegrityDebugSeederService();
      final debugPath = await seeder.resolveDebugDatabasePath();
  ...
  test(
    'κανονική βάση δεν σημαίνεται — ακόμη κι αν λέγεται integrity_debug.db',
    () async {
