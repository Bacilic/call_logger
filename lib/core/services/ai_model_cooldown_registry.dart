...
///
/// Το μήνυμα έλεγε κάποτε πάντα «αναμονή ποσόστωσης», ακόμη κι όταν η αιτία
/// ήταν υπερφόρτωση ή ανύπαρκτο μοντέλο — και ο χρήστης έψαχνε ποσόστωση που
/// δεν είχε εξαντληθεί. Η φράση ζει εδώ ώστε κάθε οθόνη που μιλά στην ΤΝ να
/// εξηγεί την αναμονή με τα ίδια λόγια.
String aiModelWaitReasonText(AiModelDownReason? reason) => switch (reason) {
