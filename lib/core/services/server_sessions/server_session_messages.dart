...
abstract final class ServerSessionMessages {
  ...
  ///
  /// Το [staleShare] είναι υποχρεωτικό επίτηδες: κάθε ροή το ξέρει (το δίνει η
  /// ίδια η πύλη σύνδεσης) και καμία δεν επιτρέπεται να το αφήσει πίσω. Μετράει
  /// μόνο στη σύγκρουση στοιχείων — εκεί μετατρέπει μια γενική οδηγία
  /// «αποσύνδεση ή επανεκκίνηση» στην ακριβή ενέργεια που χρειάζεται.
  static String forConnect({
    ...
    errorSessionCredentialConflict when staleShare =>
      'Αυτός ο υπολογιστής έχει ήδη ανοιχτή σύνδεση προς τον $host με άλλον '
          'λογαριασμό, και δεν ήταν δυνατόν να κλείσει: την κρατούν ανοιχτά '
          'αρχεία ή κάποιο πρόγραμμα σε χρήση — π.χ. κοινόχρηστος φάκελος ή '
          'δίσκος δικτύου του $host. Κλείσε ό,τι είναι ανοιχτό από τον $host '
          'και δοκίμασε ξανά· αν επιμείνει, χρειάζεται επανεκκίνηση του '
          'υπολογιστή.',
