...
class _AppShortcutsState extends ConsumerState<AppShortcuts>
  ...
  void _warnIfMissingStartupAssets() {
    ...
    messenger.showMaterialBanner(
      MaterialBanner(
        // Η λωρίδα σπρώχνει το περιεχόμενο προς τα κάτω: όσο ψηλώνει, τόσο
        // ύψος χάνει η οθόνη από κάτω της. Χωρίς φράγμα γραμμών, σε στενό
        // παράθυρο το κείμενο τυλίγεται σε τόσες γραμμές που η ίδια η
        // ειδοποίηση προκαλεί σφάλμα διάταξης. Η ενέργεια μπαίνει **πριν** τη
        // λίστα ώστε, αν κοπεί κάτι, να είναι τα ονόματα και όχι το τι να κάνει
        // ο χρήστης — η πλήρης λίστα υπάρχει ήδη στα διαγνωστικά εκκίνησης.
        content: Text(
          'Η εφαρμογή λειτουργεί περιορισμένα· συνιστάται επανεγκατάσταση. '
          'Λείπουν αρχεία: ${missing.join(', ')}.',
          maxLines: 3,
