...
class AppConfig {
  ...
  /// Πόσο περιμένει μια εγγραφή όταν τη βάση την κρατά ήδη άλλος, σε χιλιοστά.
  ///
  /// Η SQLite ξεκινά κάθε σύνδεση στο μηδέν — δηλαδή «παραιτήσου αμέσως».
  /// Μετρημένο σε κοινόχρηστη βάση 18/08/2026: ο δεύτερος γραφέας απέτυχε σε
  /// 3 χιλιοστά με «database is locked», και στους δύο τρόπους ημερολογίου.
  /// Το δίκτυο παίρνει μεγαλύτερο περιθώριο επειδή και η ίδια η εγγραφή εκεί
  /// είναι πιο αργή (76 ms έναντι 9 ms τοπικά, μετρημένο την ίδια μέρα).
  static const int databaseBusyTimeoutNetworkMs = 15000;
  static const int databaseBusyTimeoutLocalMs = 5000;
