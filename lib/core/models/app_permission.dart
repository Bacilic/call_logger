...
///
/// Σήμερα **όλα επιτρέπονται από προεπιλογή** — ο κατάλογος υπάρχει ως υποδομή
/// και δεν αλλάζει καμία συμπεριφορά. Η επιβολή, και η επιλογή του τι κλειδώνει
/// και για ποιον, είναι ξεχωριστή δουλειά με δική της οθόνη. Η προεπιλογή
/// γράφεται ρητά σε κάθε εγγραφή ώστε η μελλοντική αλλαγή της να φαίνεται.
enum AppPermission {
  manageEmployees(
