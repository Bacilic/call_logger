...
abstract final class AuditDiffHelper {
  ...
  ///
  /// Πεζό αρχικό παντού: οι ετικέτες μπαίνουν μέσα σε πρόταση («2 αλλαγές:
  /// θέμα, διάρκεια»), οπότε ένα κεφαλαίο στη μέση διαβάζεται ως λάθος.
  static const Map<String, String> _titleLabels = {
    ...
    'via': 'προέλευση',
    'comment': 'σχόλιο',
    'anydesk_id': 'κωδικός AnyDesk',
    'custom_ip': 'διεύθυνση απομακρυσμένης',
    'default_remote_tool': 'κύριο εργαλείο',
    'lansweeper_main_ticket_id': 'εισιτήριο Lansweeper',
    'lansweeper_last_sync_at': 'συγχρονισμός Lansweeper',
    'lansweeper_username': 'αναγνωριστικό Lansweeper',
    'lansweeper_asset_name': 'αναγνωριστικό Lansweeper',
    'lansweeper_usernames': 'αναγνωριστικά Lansweeper',
    'is_deleted': 'διαγραφή',
    'integrity_fix': 'επιδιόρθωση ακεραιότητας',
    'status': 'κατάσταση',
    ...
    // Το κλειδί που γράφει το audit είναι `equipment_code`· το `code_equipment`
    // είναι το όνομα της στήλης και μένει για τις ήδη γραμμένες εγγραφές.
    'equipment_code': 'κωδικός εξοπλισμού',
    ...
    'table': 'πίνακας',
    'affected_ids': 'επηρεαζόμενες εγγραφές',
    'fields': 'πεδία',
  };
  ...
  static const Map<String, String> _detailLabels = {
    ...
    'via': 'προέλευσης',
    'comment': 'σχολίου',
    'anydesk_id': 'κωδικού AnyDesk',
    'custom_ip': 'διεύθυνσης απομακρυσμένης',
    'default_remote_tool': 'κύριου εργαλείου',
    'lansweeper_main_ticket_id': 'εισιτηρίου Lansweeper',
    'lansweeper_last_sync_at': 'συγχρονισμού Lansweeper',
    'lansweeper_username': 'αναγνωριστικού Lansweeper',
    'lansweeper_asset_name': 'αναγνωριστικού Lansweeper',
    'lansweeper_usernames': 'αναγνωριστικών Lansweeper',
    'is_deleted': 'διαγραφής',
    'integrity_fix': 'επιδιόρθωσης ακεραιότητας',
    'status': 'κατάστασης',
    ...
    'issue': 'θέματος',
    'issue_refined': 'αναλυτικής περιγραφής',
    'solution': 'λύσης',
    'topic': 'τίτλου άρθρου',
    'symptom': 'συμπτώματος',
    'content': 'λύσης άρθρου',
    ...
    'equipment_code': 'κωδικού εξοπλισμού',
    ...
    'table': 'πίνακα',
    'affected_ids': 'επηρεαζόμενων εγγραφών',
    'fields': 'πεδίων',
  };
  ...
  static const Map<String, String> _searchLabels = {
    ...
    'via': 'προελευση',
    'comment': 'σχολιο',
    'anydesk_id': 'κωδικος anydesk',
    'custom_ip': 'διευθυνση απομακρυσμενης',
    'default_remote_tool': 'κυριο εργαλειο',
    'lansweeper_main_ticket_id': 'εισιτηριο lansweeper',
    'lansweeper_last_sync_at': 'συγχρονισμος lansweeper',
    'is_deleted': 'διαγραφη',
    'integrity_fix': 'επιδιορθωση ακεραιοτητας',
    'status': 'κατασταση',
    ...
    'equipment_code': 'κωδικος εξοπλισμου',
    ...
    'table': 'πινακας',
    'affected_ids': 'επηρεαζομενες εγγραφες',
    'fields': 'πεδια',
    'trigger': 'εναυσμα',
  };
  ...
  static bool shouldSkipDerivativeField(String field, Set<String> keys) {
    ...
    // Ο κωδικός γράφεται μαζί με το id του εξοπλισμού σε κάθε συσχέτιση από
    // κλήση: μία σύνδεση, δύο κλειδιά — μετρούσαν «2 αλλαγές» για μία πράξη.
    //
    // Φεύγει το **id**, μένει ο κωδικός: ο εξοπλισμός δεν έχει resolver που να
    // μετατρέπει το id σε αναγνωρίσιμο όνομα (όπως έχουν τμήματα και χρήστες),
    // οπότε το «114» δεν λέει τίποτα ενώ το «3180» είναι ό,τι ξέρει ο χρήστης.
    if (field == 'equipment_id' && keys.contains('equipment_code')) return true;
    return false;
  }
