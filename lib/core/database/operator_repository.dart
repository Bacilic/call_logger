...
class OperatorRepository {
  ...
  /// λογαριασμό;» της φόρμας χρηστών οφείλει να βλέπει και τα απενεργοποιημένα,
  ...
  /// απενεργοποιημένα — δες [OperatorIdentity.resolveAndActivate].
  ...
  /// Πόσα προφίλ μπορούν να χρησιμοποιηθούν — τα απενεργοποιημένα δεν μετρούν.
  ...
  ///
  /// Μετρά μόνο τους ενεργούς, και το όνομα το λέει: ο απενεργοποιημένος
