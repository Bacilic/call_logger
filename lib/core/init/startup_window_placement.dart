...
/// Πόσο περιμένει η εκκίνηση την επαναφορά του παραθύρου πριν ανοίξει έτσι κι
/// αλλιώς.
///
/// Η επαναφορά ρωτά το λειτουργικό πέντε φορές και τη βάση τρεις· καθεμιά
/// μπορεί να αργήσει. Το φρένο υπάρχει για να μη μετατραπεί μια αργοπορία σε
/// κλειστή πόρτα: μια διεπαφή που ξεχειλίζει είναι ενοχλητική, μια εφαρμογή που
/// δεν ανοίγει είναι άχρηστη.
const Duration kWindowRestoreTimeout = Duration(seconds: 5);
