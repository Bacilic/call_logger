...
class CatalogScanRunner {
  ...
  static Future<List<CatalogValidationFinding>> scan(WidgetRef ref) async {
    ...
    // Κάτοχοι ανά εξοπλισμό (user_equipment) — τους χρειάζονται οι κανόνες
    // που κρίνουν σε ποιον ανήκει τελικά ένα μηχάνημα: η διασταύρωση
    // «εξοπλισμός σε υπάλληλο άλλου τμήματος» και ο έλεγχος του ορφανού.
