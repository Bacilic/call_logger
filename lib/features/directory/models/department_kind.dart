...
enum DepartmentKind {
  ...
  /// Είναι τμήμα **του ίδιου του νοσοκομείου**;
  ///
  /// Χωριστό από τα υπόλοιπα κριτήρια αν και σήμερα δίνει την ίδια απάντηση με
  /// κάποια από αυτά: εδώ το ερώτημα είναι **εργασιακό**, όχι τεχνικό — ανήκει
  /// ο άνθρωπος στον οργανισμό ή είναι εξωτερικός; Το
  /// [participatesInLansweeper] ρωτά αν υπάρχει λογαριασμός, το
  /// [canHoldHospitalInternalPhone] αν χτυπά τετραψήφιο. Αν αύριο κάποιο από
  /// αυτά αλλάξει, δεν πρέπει να παρασύρει μαζί του τη φράση «φεύγει από το
  /// νοσοκομείο».
  bool get belongsToHospital => this == DepartmentKind.hospital;
