...
enum DepartmentKind {
  ...
  /// Τόπος — «3 υπάλληλοι μένουν **στην εταιρεία**».
  ///
  /// Γράφεται ολόκληρο, όπως και οι υπόλοιπες πτώσεις: η συγχώνευση του «σε»
  /// με το άρθρο δεν είναι κανόνας που βγαίνει από τη λέξη — «στο τμήμα» αλλά
  /// «στην εταιρεία».
  String get entityWhere => switch (this) {
    DepartmentKind.hospital => 'στο τμήμα',
    DepartmentKind.company => 'στην εταιρεία',
    DepartmentKind.externalUnit => 'στην εξωτερική μονάδα',
  };
  ...
  /// Μπορεί να κρατά **εσωτερικό του δικού μας τηλεφωνικού κέντρου**;
  ///
  /// **Μόνο το νοσοκομείο** — και εδώ το κριτήριο είναι αυστηρότερο από την
  /// κατοχή εξοπλισμού. Η εξωτερική μονάδα δουλεύει με δικά μας μηχανήματα,
  /// αλλά έχει **δικό της δεκαψήφιο**, όχι τετραψήφιο δικό μας: ένα εσωτερικό
  /// του νοσοκομείου δεν χτυπά ποτέ εκεί.
  ///
  /// Γι' αυτό δεν συγχέεται με το [canOwnEquipment]: άλλο το μηχάνημα που
  /// ταξιδεύει, άλλο η γραμμή που είναι καρφωμένη στο κέντρο μας.
  bool get canHoldHospitalInternalPhone => this == DepartmentKind.hospital;
