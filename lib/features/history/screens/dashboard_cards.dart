...
///
/// Το κουμπί λέει «Προβολή όλων» — η υπόδειξη είναι που λέει τι ταξιδεύει μαζί
/// του: τα φίλτρα της οθόνης, το διάστημα, και με τι σειρά θα βρει τις κλήσεις.
String dashboardOpenHistoryTooltip(String sortHint) =>
    'Μετάβαση στο Ιστορικό Κλήσεων — ίδια φίλτρα και χρονικό διάστημα, '
    '$sortHint';
