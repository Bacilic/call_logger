...
const String kLansweeperReportShortcutTooltip =
    'Αναφορά Lansweeper — οι σημερινές κλήσεις (Ctrl+Shift+L)';
...
/// μέρα. Επιστρέφει `false` όταν η αναφορά είναι ήδη ανοιχτή, ώστε μια δεύτερη
...
Future<bool> openLansweeperReport(
  ...
  _isOpen = true;
  ref.read(lansweeperReportScopeProvider.notifier).set(scope);
  try {
