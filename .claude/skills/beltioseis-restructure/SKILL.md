...
- **Δ** = Διόρθωση σφάλματος → τμήμα «Α. Διορθώσεις»
- **Π** = Προσθήκη λειτουργίας → τμήμα «Β. Προσθήκες»
...
- **Ε** = ~~ολοκληρωμένο~~ — **ΚΑΤΑΡΓΗΜΕΝΟΣ ΚΩΔΙΚΟΣ.** Το τμήμα «Ε. Ολοκληρώθηκαν» δεν υπάρχει από 04/08/2026 (ρητή εντολή χρήστη: «μόνο ό,τι μένει να γίνει»). Ό,τι έκλεισε **αφαιρείται** από το αρχείο· το ίχνος ζει στο `assets/changelog.json`. Μην ξαναφτιάξεις το τμήμα και μην αποδώσεις κωδικό Ε σε καμία καταχώρηση.
...
**Και οι τέσσερις ενότητες** (Α. Διορθώσεις, Β. Προσθήκες, Γ. Προς συζήτηση,
Δ. Προτάσεις Claude) χωρίζονται σε δύο υποενότητες, **πάντα με αυτή τη σειρά**:
